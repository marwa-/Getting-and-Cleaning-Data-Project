...
destfile<-"C://Users/marwa/OneDrive/Data Science/Cleaning Data/week4/UCI HAR Dataset/test/X_test.txt"
X_test<-read.table(destfile ,  header = FALSE)
destfile<-"C://Users/marwa/OneDrive/Data Science/Cleaning Data/week4/UCI HAR Dataset/test/y_test.txt"
Y_test<-read.table(destfile ,  header = FALSE)
destfile<-"C://Users/marwa/OneDrive/Data Science/Cleaning Data/week4/UCI HAR Dataset/train/X_train.txt"
X_train<-read.table(destfile ,  header = FALSE)
destfile<-"C://Users/marwa/OneDrive/Data Science/Cleaning Data/week4/UCI HAR Dataset/train/y_train.txt"
Y_train<-read.table(destfile ,  header = FALSE)
destfile<-"C://Users/marwa/OneDrive/Data Science/Cleaning Data/week4/UCI HAR Dataset/features.txt"
features<-read.table(destfile ,  header = FALSE , stringsAsFactors = FALSE )
features[,1]<-as.numeric(features[,1])
destfile<-"C://Users/marwa/OneDrive/Data Science/Cleaning Data/week4/UCI HAR Dataset/activity_labels.txt"
...
write.table(selected_tidy_data, "tidy.txt", row.names = FALSE, quote = FALSE)
library(reshape2)
...
write.table(tidy_melted_data, "tidy_average.txt", row.names = FALSE, quote = FALSE)
